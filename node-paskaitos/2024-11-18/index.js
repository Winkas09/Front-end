...
// const carBrands = ['Audi', 'BMW', 'Mercedes', 'Volkswagen', 'Toyota', 'Honda', 'Ford', 'Chevrolet', 'Fiat', 'Renault'];

// app.get('/car-brands', (req, res) => {
//     res.json(carBrands);
// });

// app.post('/car-brands', (req, res) => {
...
//     { name: "Antanas", surname: "Petraitis" }
// ];
...
app.get('/people/car/:brand', (req, res) => {
    const brand = req.params.brand;
    const peopleWithCar = data.filter(person => person.car === brand);
    res.json(peopleWithCar);
} );
...
app.get('/females', (req, res) => {
    const females = data.filter(person => person.gender.toLocaleLowerCase()==='female')
